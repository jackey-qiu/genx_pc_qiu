...
class domain_creator_sorbate():
    ...
    def adding_sorbate_tridentate_tetrahedral(self,domain,attach_atm_ids_ref=['id1','id2'],attach_atm_id_third=['id3'],offset=[None,None,None],sorbate_id='Sb_id',sorbate_el='Sb',sorbate_oxygen_ids=['HO1']):
        #here only consider the configuration of regular octahedra
        #and here consider the tridentate complexation configuration 
        #two steps:
        #step one: use the coors of the two reference atoms, and the third one to calculate a new third one such that this new point and 
    ...
    def adding_sorbate_bidentate_tetrahedral(self,domain,phi=0,attach_atm_ids=[],offset=[None,None],sorbate_id='As1',sorbate_el='As',O_id=['HO1','HO2'],anchor_ref=None,anchor_offset=None):
