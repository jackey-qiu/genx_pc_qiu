...
class MainFrame(wx.Frame):
    def __init__(self, show_startup, *args, **kwds):
        ...
        self.plot_notebook_edensity = wx.Panel(self.plot_notebook, -1)
        self.plot_notebook_datum = wx.Panel(self.plot_notebook, -1)
        ...
        self.plot_datum = plotpanel.FomScanPlotPanel(self.plot_notebook_datum, config = self.config, config_name = 'full dataset plot', )
        self.plot_edensity = plotpanel.FomScanPlotPanel(self.plot_notebook_datum, config = self.config, config_name = 'Electron density profile', )
    ...
    def __do_layout(self):
        ...
        sizer_9.Add(self.plot_datum, 9, wx.EXPAND, 0)
        self.plot_notebook_datum.SetSizer(sizer_9)
        sizer_10.Add(self.plot_edensity, 1, wx.EXPAND, 0)
        self.plot_notebook_edensity.SetSizer(sizer_10)
        ...
        self.plot_notebook.AddPage(self.plot_notebook_datum, "Datum")
        self.plot_notebook.AddPage(self.plot_notebook_edensity, "Electron density")
